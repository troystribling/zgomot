...
The notes of a chord and chord progression can be routed to different MIDI channels to be rendered by different instruments using the <tt>note</tt> command. This makes harmonizing instruments easy.
