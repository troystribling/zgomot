...
A Note List is a set of notes played simultaneously. The Note List may contain any number of notes and its duration is the duration of the longest note in the list. It is defined by
